...
(function () {
  ...
  var MOON_SVG = '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/></svg>';

  // ---------- tema claro/escuro/sistema ----------
  var SUN_SVG = '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="5"/><line x1="12" y1="1" x2="12" y2="3"/><line x1="12" y1="21" x2="12" y2="23"/><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"/><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"/><line x1="1" y1="12" x2="3" y2="12"/><line x1="21" y1="12" x2="23" y2="12"/><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"/><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"/></svg>';
  var MOON_SVG = '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/></svg>';
  var MONITOR_SVG = '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="3" width="20" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg>';
  ...
  function applyTheme(pref) {
    ...
    if (btn) btn.innerHTML = pref === "dark" ? MOON_SVG : pref === "light" ? SUN_SVG : MONITOR_SVG;
    var menu = document.getElementById("theme-menu");
    if (menu) menu.querySelectorAll("button[data-theme-opt]").forEach(function (b) {
      b.classList.toggle("on", b.getAttribute("data-theme-opt") === pref);
    });
    try { localStorage.setItem("tributax_theme", pref); } catch (e) {}
  }
  var themeBtn = document.getElementById("theme-btn");
  var themeMenu = document.getElementById("theme-menu");
  if (themeBtn && themeMenu) {
    themeBtn.addEventListener("click", function (e) { e.stopPropagation(); themeMenu.classList.toggle("open"); });
    document.addEventListener("click", function () { themeMenu.classList.remove("open"); });
    themeMenu.querySelectorAll("button[data-theme-opt]").forEach(function (b) {
  ...
  if (window.matchMedia) window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change", function () {
    try { if (localStorage.getItem("tributax_theme") === "system") applyTheme("system"); } catch (e) {}
  });
