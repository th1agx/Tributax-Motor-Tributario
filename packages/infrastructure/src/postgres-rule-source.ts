...
import { DateRange, icmsRuleCatalog, pisCofinsRuleCatalog, issRetentionRuleCatalog, ipiRuleCatalog, ibsCbsRuleCatalog } from "@tributax/domain";
...
export async function seedRuleCatalog(databaseUrl: string): Promise<number> {
  ...
  const catalog = [...icmsRuleCatalog(), ...pisCofinsRuleCatalog(), ...issRetentionRuleCatalog(), ...ipiRuleCatalog(), ...ibsCbsRuleCatalog()];
